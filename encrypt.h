...
static int sub_6EC3D60(int a1, int a2, int a3, int a4, int a5, int a6)
{
	...
	//  a4 | a5 ^ a6 | (a1 ^ a2) & 0x3FFFFFF;
	v19 = a1;
	v6 = a4 | a5 ^ a6 | (a1 ^ a2) & 0x3FFFFFF;
	v7 = 0;
	do
	{
		v18[v7] = __ROL4__(a3 | 1, v7);
		++v7;
	} while (v7 < 32);
	v8 = 0;
	v9 = v18;
...
static int __fastcall sub_6EC3D40(int a1, int a2)
{
	return a1 ^ 9837702 * a2 & 0x3FC01FF ^ __ROR4__(a1, 7) ^ __ROL4__(a1, 13);
}

static int __fastcall sub_6EC3F10(unsigned int a1, int a2)
{
	unsigned int v2; // ebx
	int v3; // esi
	unsigned int v4; // eax
...
static int __fastcall setupval_enc(int a1, int a2)
{
	int v2; // ebx
	int v3; // esi
	unsigned int v4; // eax
	...
	{
		v5 = v4 | ((v3 & 0x1FF) << 9);
		v6 = sub_6EC3D60(5, v4 | ((v3 & 0x1FF) << 9), v2, 524416, 9837702, 66847231);
		if (v5 == sub_6EC3D40(v6, v2))
			break;
		v4 = v10;
		if (++v3 > 511)
			return sub_6EC3F10(v9, v2);
	}
	return v7;
}

static int __fastcall sub_6EC3D20(int a1, int a2)
{
	return a1 ^ -10065 * a2 & 0x3FFFF ^ __ROR4__(a1, 6) ^ __ROL4__(a1, 9);
}

static int __fastcall sub_6EC3EA0(int a1, int a2)
{
	int v2; // eax
	int v3; // ebx
	int v4; // esi
...
static uint32_t dax_encode_op(uint32_t x, uint32_t mulEven, uint32_t addEven, uint32_t mulOdd, uint32_t addOdd) {
	uint32_t result = 0;
	uint32_t mask = 1;
